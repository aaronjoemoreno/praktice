  ...
  const mission = data.missionSection.body[0].children[0].text;
    ...
    return (
        <Container>
            ...
            <div  id="values" style={{borderBottom: `2px solid var(--main-color)`, padding: `4rem 0 4rem 0`}} className="value">
            ...
            <div id="mission" style={{borderBottom: `2px solid var(--main-color)`, padding: `4rem 0 4rem 0`}} className="mission">
              <div style={{position: `relative`}}>
