  ...
  console.log(data);
    ...
    return (
        <Container>
            ...
            <Img fluid={data.images.nodes[3].fluid} className="main-logo" alt="praktice logo" style={{width: `50%`, margin: `0 auto`}}/>
            ...
            <div className="about-vision">
                ...
                <div className="integrity">
                    <p>KINDNESS in our COMMUNICATION towards our fellow practitioners and customers which will create a steadfast PROFESSIONAL path of mutual GROWTH, increasing KNOWLEDGE and ETHICS</p>

                    <Img fluid={data.images.nodes[2].fluid} className="main-logo" alt="praktice logo" style={{width: `100%`}}/>
                </div>

                <h3>Our Mission:</h3>
                <div className="mission">
                    <Img fluid={data.images.nodes[1].fluid} className="main-logo" alt="praktice logo" style={{width: `100%`}}/>
                    <p>PRAKTICE  will work to create a powerful community of Independent professional practitioners which can help, who can enrich each other and grow together by establishing a network of knowledge, clients, methodologies, ideas and collaborations.</p>
